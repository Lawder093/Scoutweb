  ...
  return (
    <section id="cde" className="overflow-hidden bg-paper py-24 sm:py-32">
      <div className="section-shell">
        <Reveal>
          <SectionHeading headingLevel={headingLevel} eyebrow="La red" title={<>Crecer en <span className="text-secondary">comunidad.</span></>} description="Hoy los CDE activos están en México, Colombia y Argentina." />
        </Reveal>
