      ...
      >
        <div className="flex h-[62px] items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/sumate" className={`focus-ring hidden rounded-full px-5 py-3 text-xs font-bold uppercase tracking-[0.12em] transition-transform hover:-translate-y-0.5 md:block ${isDarkGlass ? "bg-white text-ink" : "bg-ink text-white"}`}>
              Súmate
            </Link>
            <Link
              href={loginItem.href}
