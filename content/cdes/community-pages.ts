...
export function getCommunityPage(cde: CDEData, community: CDECommunity): CDECommunityPageData {
  if (community.page) {
    return {
      ...community.page,
      photoReel: community.photoReel ?? community.page.photoReel ?? communityPhotoReels[community.kind],
    };
  }
  ...
  return {
    ...template,
    photoReel: community.photoReel ?? template.photoReel ?? communityPhotoReels[community.kind],
