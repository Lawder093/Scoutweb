...
const mexicoPhotoReels: Partial<Record<CDECommunityKind, CDECommunityPhoto[]>> = {
  Ronda: [
    ...
    localPhoto({ folder: "RondaMexico", community: "Ronda", file: "IMG_0819.jpeg", label: "Explorar juntos", size: "large" }),
  ...
  Tropa: [
    ...
    localPhoto({ folder: "TropaMexico", community: "Tropa", file: "IMG_0396.jpeg", label: "Caminar juntos", size: "large" }),
