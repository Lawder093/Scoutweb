...
const donataria: LegalPage = {
  ...
  blocks: [
    ...
    { type: "paragraph", text: "Metas 4.1, 4.4 y 4.7: Ser coadyuvantes para que todos los niños y adolescentes terminen la enseñanza primaria y secundaria, con el apoyo de los insumos escolares requeridos. Promover las competencias adecuadas en los adolescentes para acceder al empleo, el trabajo decente y el emprendimiento. Promover conocimientos teóricos y prácticos necesarios para alcanzar el desarrollo sostenible, entre otras cosas, mediante la educación para el desarrollo sostenible y los estilos de vida sostenibles, los derechos humanos, la igualdad de género, la promoción de una cultura de paz y no violencia, la ciudadanía mundial y la valoración de la diversidad cultural y la contribución de la cultura al desarrollo sostenible." },
